...
export type Tab = "log" | "aiHistory" | "settings";
...
export function TabBar({ active, onTab }: Props) {
	...
	return (
		<View
			...
			<TouchableOpacity style={styles.tab} onPress={() => onTab("aiHistory")}>
				<Ionicons
					name={active === "aiHistory" ? "sparkles" : "sparkles-outline"}
					size={30}
					color={theme.colors.primary}
				/>
				<Text
					style={[styles.label, active === "aiHistory" && styles.labelActive]}>
					AI分析紀錄
				</Text>
			</TouchableOpacity>
