...
21:00), *not* an interval like "every 30 minutes."
...
- Gentle Cantonese copy, e.g. 「今日痾咗未呀？記低佢啦 💩」
- *(Later idea)* a "smart nudge" that only reminds if nothing has been logged yet
  that day — not in v1.
...
- **Warm, humorous micro-copy** — e.g. confirm button 「搞掂！」, empty state
  「今日仲未痾喎，飲返多啲水先啦」, success toast 「記錄咗喇，做得好 👏」.
...
{
  "summary": "一句輕鬆總結（粵文）",
  "observations": { "color": "...", "clarity": "...", "foam": "...", "consistency": "..." },
...
**Recommendation:** pick a *rough* name or at least the **bundle identifier/App ID**
